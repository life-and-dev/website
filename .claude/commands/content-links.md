...
| Christ, Messiah, the King         | Jesus as the Christ/Messiah, King of Kingdom of God        | /content/kingdom/christ.md    |
...
If the article file path does not exist in the "target md file" column of the above [Keyword-Article Mapping Table](#keyword-article-mapping-table) in `.claude/commands/content-links.md` then, add an entry with a unique keyword, context of the keyword and include a link to the article md file.
